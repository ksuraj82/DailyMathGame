...
3. once the jar file is placed/created in the above Input folder with postgresql driver, then execute the below command in windows command line to create the windows executable file:
